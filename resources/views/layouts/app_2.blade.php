...
<!-- END PAGE LEVEL STYLES -->
    ...
    <style>
        ...
        .seleccionada_tb tr:hover{
            background-color: #deebe9;
        }

        .colorazul{
            background-color: rgba(195, 225, 241, 0.85);
        }
        .colorazuldos{
            background-color: rgba(155, 231, 250, 0.92);
        }
        ...
        .azuldiv{
            background-color: rgba(72, 124, 255, 0.8);
            font-size: 12px;
        }
        .verdediv{
            background-color: rgba(62, 159, 225, 0.8);
            font-size: 12px;
        }
        .tabla_titulo{
...
<div class="page-wrapper">
    ...
    <div class="page-header navbar navbar-fixed-top">
        ...
        <div class="page-header-inner ">
            ...
            <div class="top-menu">
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown dropdown-user">
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                            <img alt="" class="img-circle" src="{{ asset('/assets/layouts/layout/img/avatar_ih.png') }}" />
                        ...
                        <ul class="dropdown-menu dropdown-menu-default">
                            ...
                            <li>
                                <a href="#">
                                    <i class="icon-envelope-open"></i> Mi bandeja de entrada
            ...
            </div> {{-- Despues hay que trabajar las notificaciones --}}
